...
```
{
    "command": "fota",
    "streamId": "fota-image-v1-stream",
    "fileNameToSaveOnDevice": "mytest",
    "fileId": *any_integer_between_1_to_255*,
    "fileSize": *your_fota_image_size_in_Bytes*
}
```

There is an optional property ***cmdToBeExecutedAfterDownload*** for you to execute commands after download (Ex. execute the file that you just downloaded).  You can add this optional property as below:
...
```
{
    ...
    "fileId": *any_integer_between_1_to_255*,
    "fileSize": *your_fota_image_size_in_Bytes*,
    "cmdToBeExecutedAfterDownload": "your_commands"
}
```
